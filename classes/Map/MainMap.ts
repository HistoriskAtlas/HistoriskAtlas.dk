class MainMap extends ol.Map {
    ...
    public ready() {
        ...
        setTimeout(() => App.global.set('timeWarpActive', (LocalStorage.showTimeWarp && !App.passed.geo) || App.global.theme.secondarymapid), 0); //make sure the timewarp opens if it should
    }

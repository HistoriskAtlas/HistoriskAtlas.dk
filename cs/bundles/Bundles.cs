...
namespace HistoriskAtlas5.Frontend
{
    public class Bundles
    {
        ...
        private static string[] GeoOnlyElements = new string[] { "windows/window-basic", "windows/window-geo", "windows/window-geo/window-geo-biblio", "windows/window-geo/window-geo-tag-list", "windows/window-geo/window-geo-by-line", "windows/window-image", "input/rich-text", "input/plain-text", "collections/base", "collections/ha-geo", "collections/ha-contents", "collections/ha-image", "collections/ha-licenses", "icons/licens-mark", "icons/cc-icons", "content-viewer" };
